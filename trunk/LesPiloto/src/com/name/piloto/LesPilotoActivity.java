...
//		
	...
	private void telaPrincipal() {
		...
		Button btListaMatriculada = (Button) findViewById(R.main.listaEmCurso);
		
		btListaMatriculada.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				telaListaMatriculada();
		...
		Button btListaCursadas = (Button) findViewById(R.main.listaCursadas);
		
		btListaCursadas.setOnClickListener(new View.OnClickListener() {
	...
	private void telaListaMatriculada() {
		setContentView(R.layout.listamatriculada);
		
		TextView tvCadeirasMatriculadas = (TextView) findViewById(R.listaMatriculadas.textView2ListaDeCadeirasMatriculadas);
		
		tvCadeirasMatriculadas.setText(cadeirasMatriculadas());
		
		Button btListaMatriculada = (Button) findViewById(R.listaMatriculadas.listaMatriculadaVoltar);
		
		btListaMatriculada.setOnClickListener(new OnClickListener() {
	...
	private void telaListaCursada() {
		setContentView(R.layout.listacursadas);
		
		TextView tvCadeirasCursadas = (TextView) findViewById(R.listaCursadas.textView2ListaDeCadeirasCursadas);
		
		tvCadeirasCursadas.setText(cadeirasCursadas());
		
		Button btVoltarCursads = (Button) findViewById(R.listaCursadas.listaCursadasVoltar);
		
		btVoltarCursads.setOnClickListener(new View.OnClickListener() {
	...
	private String cadeirasCursadas() {
		return gr.disciplinasCursadasString();
	}
